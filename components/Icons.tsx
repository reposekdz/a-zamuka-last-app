...
export const HomeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a.75.75 0 011.06 0l8.955 8.955a.75.75 0 01-.53 1.28H19.5V21a.75.75 0 01-.75.75H5.25a.75.75 0 01-.75-.75V13.28H2.78a.75.75 0 01-.53-1.28z" />
    </svg>
);

export const PiggyBankIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 8.25h13.5m-13.5 4.5h13.5m-13.5 4.5h13.5m-15.75-8.25a3 3 0 013-3h11.25a3 3 0 013 3v4.5a3 3 0 01-3 3h-11.25a3 3 0 01-3-3v-4.5zM6 16.5v.75a3 3 0 003 3h4.5a3 3 0 003-3v-.75" />
    </svg>
);

export const LoanIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0l.879-.659M7.5 12a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0z" />
    </svg>
);

export const UsersIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.502 2.72a3 3 0 01-4.682-2.72 9.094 9.094 0 013.741-.479m7.502 2.72c-1.247 1.247-2.88 1.9-4.682 1.9s-3.435-.653-4.682-1.9M12 18.72v-2.22m0-10.22v-2.22m0 0a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zM12 11.25a2.25 2.25 0 110-4.5 2.25 2.25 0 010 4.5z" />
    </svg>
);
...
export const BanknotesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h6m-6 2.25h6M2.25 19.5h19.5M2.25 12h19.5M2.25 6h19.5" />
    </svg>
);
...
export const GiftIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v16.5m-3.75-9H15.75M4.5 11.25h15" />
    </svg>
);
...
export const ClipboardIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042m-7.416 0V3.888c-.055-.194-.084-.4-.084-.612a2.25 2.25 0 012.25-2.25h3c1.03 0 1.9.693 2.166 1.638m-7.332 0l-3.162 3.162M12 12.75h4.5m-4.5 3h4.5M12 18h4.5m-7.5-12h7.5a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25h-7.5a2.25 2.25 0 01-2.25-2.25V6.75a2.25 2.25 0 012.25-2.25z" />
    </svg>
);
...
export const FacebookIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
        <linearGradient id="Ld6sqrtcxMyckEl6oeadsa_uLSV490CtYe8_gr1" x1="9.993" x2="40.615" y1="9.993" y2="40.615" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#2aa4f4"></stop><stop offset="1" stopColor="#007ad9"></stop></linearGradient><path fill="url(#Ld6sqrtcxMyckEl6oeadsa_uLSV490CtYe8_gr1)" d="M24,4C12.954,4,4,12.954,4,24s8.954,20,20,20s20-8.954,20-20S35.046,4,24,4z"></path><path fill="#fff" d="M26.707,26.106L28.77,21.08h-4.226v-3.326c0-1.291,0.359-2.17,2.21-2.17h2.358v-4.528 c-0.407-0.054-1.802-0.175-3.424-0.175c-3.389,0-5.717,2.067-5.717,5.881v3.326h-3.837v5.026h3.837v12.164h5.095 V26.106z"></path>
    </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9 9 0 119 0zM16.5 18.75a9 9 0 00-9 0m9 0h.008v.008h-.008v-.008zm-9 0h-.008v.008h.008v-.008zM16.5 18.75a9 9 0 01-9 0m-2.25-6.75a.75.75 0 01.75-.75h12.75a.75.75 0 010 1.5H5.25a.75.75 0 01-.75-.75zM12 6.75a.75.75 0 00-.75.75v3.75a.75.75 0 001.5 0V7.5a.75.75 0 00-.75-.75zM12 3.75a.75.75 0 01.75.75v.008a.75.75 0 01-1.5 0V4.5a.75.75 0 01.75-.75z" />
    </svg>
);
...
export const RocketLaunchIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.96 14.96 0 00-5.84-2.56m0 0a14.96 14.96 0 01-5.84 2.56m5.84-2.56V4.72a.75.75 0 00-1.5 0v4.82m1.5 0a14.96 14.96 0 00-5.84 2.56m5.84-2.56L12 11.25m0 0l-2.25 3.125M12 11.25L9.75 8.125M12 11.25L14.25 8.125" />
    </svg>
);
